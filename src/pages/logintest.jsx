...
export default function Auth() {
  ...
  const getSalt = async () => {
    const saltRes = await fetch(`https://macstrombattle-api.kglame.com/api/auth/salt`);
  ...
  const handleRegistration = async () => {
    ...
    try {
      ...
      const res = await fetch("https://macstrombattle-api.kglame.com/api/auth/register", {
        method: "POST",
  ...
  const handleLogin = async () => {
    ...
    try {
      const saltRes = await fetch(`https://macstrombattle-api.kglame.com/api/auth/salt?username=${username}`);
      if (!saltRes.ok) {
      ...
      // Send login request
      const res = await fetch("https://macstrombattle-api.kglame.com/api/auth/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
