...
const Dashboard = () => {
  ...
  const [chartData, setChartData] = useState([]); // Token from localStorage
  const authToken = localStorage.getItem("authToken"); // Helper function to extract array data from API response
  ...
  const fetchData = async () => {
    try {
      ...
      setTeams(extractArray(teamsData, ["teams", "data"])); // Sets the total teams count // Combine tournaments data

      const allTournaments = [
        ...(Array.isArray(pubgTournamentsData)
          ? pubgTournamentsData
          : pubgTournamentsData.data || []),
        ...(Array.isArray(freefireTournamentsData)
          ? freefireTournamentsData
          : freefireTournamentsData.data || []),
      ];
      ...
      setSubscriptions(
        extractArray(subscriptionsData, ["subscriptions", "data"])
      ); // 1. Set Total Members
      ...
      const combinedTeams = fullTeamList.map((adminTeam) => {
        ...
        return {
          ...
          totalMembers: accurateData
            ? accurateData.total
            : adminTeam.members?.length || 0,
          byGame: accurateData?.byGame || {}, // Add game info if available
        };
      });

      setAllTeamsForOverview(combinedTeams); // Build chart data (unchanged)
      ...
      for (let i = 29; i >= 0; i--) {
        ...
        const usersOnDate = extractArray(usersData, ["users", "data"]).filter(
          (user) =>
            user.createdAt &&
            format(parseISO(user.createdAt), "yyyy-MM-dd") === dateStr
        ).length;

        const tournamentsCount = allTournaments.filter(
          (tournament) =>
            tournament.createdAt &&
            format(parseISO(tournament.createdAt), "yyyy-MM-dd") === dateStr
        ).length;

        const subscriptionsOnDate = extractArray(subscriptionsData, [
          "subscriptions",
          "data",
        ]).filter(
          (sub) =>
            sub.createdAt &&
            format(parseISO(sub.createdAt), "yyyy-MM-dd") === dateStr
        ).length;
  ...
  return (
    ...
    >
      ...
      <div
        className={`backdrop-blur-sm shadow-sm border-b sticky top-0 z-10 ${
          darkMode
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          ...
          <div>
            ...
            >
              Real-time insights into your gaming platform
            </p>
                
          </div>
              
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div>
              ...
              >
                Track registrations and subscriptions over the last 30 days
              </p>
                    
            </div>
                
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div
            className={`lg:col-span-2 backdrop-blur-sm rounded-2xl shadow-lg border p-6 ${
              darkMode
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div>
                ...
                >
                  Latest tournament registrations and subscriptions
                </p>
                        
              </div>
                ...
                tournaments
                  ...
                  .map((tournament) => (
                    <div
                      ...
                      className={`flex items-center space-x-4 p-4 rounded-xl transition-all duration-200 border ${
                        darkMode
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        >
                          {tournament.createdAt
                            ? format(parseISO(tournament.createdAt), "HH:mm")
                            : "Unknown time"}
                        </p>
                                          
                        <span
                ...
                getRecentSubscriptions().map((subscription) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      >
                        {subscription.createdAt
                          ? format(parseISO(subscription.createdAt), "HH:mm")
                          : "Unknown time"}
                      </p>
                                    
                    </div>
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex -space-x-2">
                        ...
                                          
                        {[...Array(Math.min(team.totalMembers || 0, 4))].map(
                          (_, i) => (
                            <div
                              key={i}
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div>
                ...
                >
                  Registration trends and performance
                </p>
                        
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-emerald-700 font-medium">
                    Total Tournaments <br></br> Registrations
                  </p>
                              
                  <p
                    className={`text-2xl font-bold ${
                  ...
                  >
                    {
                      tournaments.filter(
                        (t) =>
                          t.createdAt &&
                          new Date(t.createdAt) > subDays(new Date(), 7)
                      ).length
                    }
                  </p>
                </div>
